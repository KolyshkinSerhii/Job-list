  ...
  return (
    <div className="flex items-center space-x-4">
      <div className="flex-shrink-0">
        <img className="w-20 h-20 rounded-full" alt='' src={job.pictures[0]}></img>
      </div>
      <div className="flex-1 min-w-0">
        <button onClick={redirectToDetailedInfo} className="text-sm font-medium text-gray-900 truncate dark:text-white">{job.title}</button>
        <p className="text-sm text-gray-500 truncate dark:text-gray-400">{job.name}</p>
        <p className="text-sm text-gray-500 truncate dark:text-gray-400">{job.address}</p>
      </div>
